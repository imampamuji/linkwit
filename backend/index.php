...
$data_link = query("SELECT block_title, block_link, block_emoji FROM data_link WHERE username = 'kominfo' ORDER BY id DESC");
...
<body class="min-h-screen bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto mt-4">
        <div>
            <figure class="p-4">
                <img class="w-32 h-32 rounded-full mx-auto" src="./img/pp.jpeg" alt="profile picture" width="400" height="400">
                <div class="pt-2 text-center space-y-4">
                    <figcaption class="font-medium">
                        <div class="text-[#CC9A2F] font-normal pb-4">
                            <a href="https://imampamuji.github.io/" target="_blank">@imampamujii</a>
                        </div>
                        <div class="text-[#1D345E] text-xl font-bold mb-2">
                           MY NAME IMAM PAMUJI
                        </div>
                        <div class="text-[#1D345E] text-xs font-normal tracking-wide">
    ...
    <div class="container mx-auto w-full my-5 ">
        <p class=" flex text-center justify-center whitespace-pre-wrap text-xs"> Made with ❤️ By<a href="#" class="hover:text-[#CC9A2F]"> ImajiTech</a></p>
    </div>
    <!-- Footer End -->
