...
<body class="min-h-screen bg-gray-100">
    ...
    <?php foreach ($data_link as $data) : ?>
        <!-- Link Start  -->
        <div class="w-full mx-auto max-w-lg float-none ">
            <div class="">
                <div class="bg-slate-400">

                </div>
                <div class="pt-2  space-y-2 p-5  ">
                    <div class="">
                        <button class="bg-slate-500  my-auto items-center rounded-lg">edit</button>

                    </div>

                    <a href="<?= $data['block_link'] ?>" target="_blank" class="flex rounded-lg  justify-center bg-[#1D345E] text-center shadow-slate-200 hover:shadow-[#CC9A2F]  py-4 text-lg leading-6 font-medium shadow-md hover:shadow-lg transition ease-in-out duration-150">
